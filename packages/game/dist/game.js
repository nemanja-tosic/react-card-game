...
var Player = exports.Player = function () {
  ...
  (0, _createClass3.default)(Player, [{
    ...
    key: 'hasPlayedAllCards',
    value: function hasPlayedAllCards() {
      return this.cards.length === 0;
    }
  }, {
    key: 'takeCards',
    value: function takeCards(cards) {
      this.score += cards.reduce(function (total, card) {
        return total + card.value;
      }, 0);
      this.takenCards = [].concat((0, _toConsumableArray3.default)(this.takenCards), [cards]);
    }
  }, {
    key: 'playCard',
    value: function playCard(cardIndex) {
      if (this.state === 'inactive') {
        throw new Error('An inactive player cannot play');
      }

      this.game.addCardToTalon(this, this.cards.splice(cardIndex, 1)[0]);
    }
  }]);
  return Player;
}();
...
var _cardService = __webpack_require__(62);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Game = exports.Game = function () {
  function Game(cardService) {
    (0, _classCallCheck3.default)(this, Game);
    this.winners = null;
    this.talon = new _map2.default();
    this.activePlayer = 0;
  ...
  (0, _createClass3.default)(Game, [{
    ...
    value: function start() {
      var deck, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, player;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _regenerator2.default.awrap(this.cardService.generateDeck());
            ...
            case 5:
              ...
              _context.prev = 9;
              _iterator = (0, _getIterator3.default)(this.players);
            ...
            case 11:
              ...
              player = _step.value;
              _context.next = 15;
              return _regenerator2.default.awrap(this.cardService.draw(deck));

            case 15:
              player.cards = _context.sent;
    ...
    key: 'addCardToTalon',
    value: function addCardToTalon(player, card) {
      var _this = this;
      ...
      var isTurnDone = this.players.length === this.talon.size;
      if (isTurnDone) {
        this._updateScore();

        var isGameOver = this.players.every(function (player) {
          return player.hasPlayedAllCards();
        });
        if (isGameOver) {
    ...
    key: '_activateNextPlayer',
    value: function _activateNextPlayer() {
    ...
    value: function _updateScore() {
      ...
      var playedCards = (0, _from2.default)(this.talon.values());
      var highestCard = playedCards.reduce(function (highCard, card) {
        return card.takes(highCard) ? card : highCard;
      }, playedCards[0]);
      var winner = (0, _from2.default)(this.talon.keys()).reverse().find(function (player) {
        return _this2.talon.get(player) === highestCard;
      });
    ...
    key: '_calculateWinners',
    value: function _calculateWinners() {
      var highScore = this.players.reduce(function (highScore, player) {
...
var CardService = exports.CardService = function () {
  function CardService() {
    (0, _classCallCheck3.default)(this, CardService);
    this.cardValueTable = new _map2.default([['KING', 14], ['QUEEN', 13], ['JACK', 12], ['ACE', 1]]);
  }

  (0, _createClass3.default)(CardService, [{
    key: 'generateDeck',
    ...
    value: function generateDeck() {
      return fetch('https://deckofcardsapi.com/api/deck/new/shuffle/').then(function (response) {
    ...
    key: 'draw',
    value: function draw(deckId) {
      var _this = this;

      return fetch('https://deckofcardsapi.com/api/deck/' + deckId + '/draw/?count=10').then(function (response) {
        return response.json();
      }).then(function (response) {
        return response.cards.map(_this._mapResponseToCardModel.bind(_this));
      });
    }
  }, {
    key: '_mapResponseToCardModel',
    value: function _mapResponseToCardModel(card) {
      return new _card.Card(card.code, card.suit, this.cardValueTable.get(card.value) || parseInt(card.value, 10));
    }
  }], [{
    key: 'create',
...
exports.createSinglePlayerGame = undefined;
...
var _computerPlayer = __webpack_require__(102);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var range = function range(start, end) {
  return (0, _from2.default)({ length: end - start + 1 }, function (v, k) {
    return k + start;
  });
};

var createSinglePlayerGame = exports.createSinglePlayerGame = function createSinglePlayerGame(playerName, numberOfOpponents) {
  var game = new _game.Game(_cardService.CardService.create());

  var player = new _player.Player(0, playerName, game);
  var ai = range(1, numberOfOpponents).map(function (index) {
    return new _computerPlayer.ComputerPlayer(index, 'Computer ' + index, game);
  });

  game.players = [player].concat((0, _toConsumableArray3.default)(ai));
...
exports.ComputerPlayer = undefined;
...
var _possibleConstructorReturn2 = __webpack_require__(105);
...
var ComputerPlayer = exports.ComputerPlayer = function (_Player) {
  (0, _inherits3.default)(ComputerPlayer, _Player);

  function ComputerPlayer() {
    (0, _classCallCheck3.default)(this, ComputerPlayer);
    return (0, _possibleConstructorReturn3.default)(this, (ComputerPlayer.__proto__ || (0, _getPrototypeOf2.default)(ComputerPlayer)).apply(this, arguments));
  }

  (0, _createClass3.default)(ComputerPlayer, [{
    key: 'setState',
    value: function setState(state) {
      var _this2 = this;
      ...
      if (state === 'active') {
        setTimeout(function () {
          var randomCard = Math.floor(Math.random() * _this2.cards.length);
          _this2.playCard(randomCard);
        }, 1000); // simulate a small delay
      }

      (0, _get3.default)(ComputerPlayer.prototype.__proto__ || (0, _getPrototypeOf2.default)(ComputerPlayer.prototype), 'setState', this).call(this, state);
    }
  }]);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(11)(Function.call, __webpack_require__(43).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
